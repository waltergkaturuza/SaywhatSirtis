...
const CATEGORY_OVERRIDES: Record<string, { enumValue: string; display: string }> = {
  ...
  // Monthly Reports - project reports by month
  monthly_reports_january: { enumValue: 'REPORT', display: 'Monthly Reports/January' },
  monthly_reports_february: { enumValue: 'REPORT', display: 'Monthly Reports/February' },
  monthly_reports_march: { enumValue: 'REPORT', display: 'Monthly Reports/March' },
  monthly_reports_april: { enumValue: 'REPORT', display: 'Monthly Reports/April' },
  monthly_reports_may: { enumValue: 'REPORT', display: 'Monthly Reports/May' },
  monthly_reports_june: { enumValue: 'REPORT', display: 'Monthly Reports/June' },
  monthly_reports_july: { enumValue: 'REPORT', display: 'Monthly Reports/July' },
  monthly_reports_august: { enumValue: 'REPORT', display: 'Monthly Reports/August' },
  monthly_reports_september: { enumValue: 'REPORT', display: 'Monthly Reports/September' },
  monthly_reports_october: { enumValue: 'REPORT', display: 'Monthly Reports/October' },
  monthly_reports_november: { enumValue: 'REPORT', display: 'Monthly Reports/November' },
  monthly_reports_december: { enumValue: 'REPORT', display: 'Monthly Reports/December' },
