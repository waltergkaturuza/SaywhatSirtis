  ...
  const handleCreateAsset = async () => {
    try {
      ...
      const assetData = {
        ...
        physicalAssetTag: createFormData.assetTag?.trim() || undefined,
        lastAuditDate: createFormData.lastAuditDate?.trim() || undefined,
        nextMaintenanceDate: createFormData.nextMaintenanceDate?.trim() || undefined,
