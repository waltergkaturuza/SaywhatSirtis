...
import { Plus, Search, Filter, Download, Eye, Edit, Trash2, Users, Clock, CheckCircle, XCircle } from 'lucide-react'
import JobPostingForm from '@/components/hr/recruitment/job-posting-form'
...
interface Application {
  ...
  email: string
  phone: string
  status: 'submitted' | 'reviewing' | 'shortlisted' | 'interviewed' | 'offered' | 'hired' | 'rejected'
  resumeUrl?: string
  coverLetter?: string
  appliedDate: string
  lastUpdated: string
