        ...
        {profile && (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
                ...
                <div className="p-6 space-y-4">
                  <div className="text-center p-4 bg-gradient-to-br from-saywhat-orange/20 to-saywhat-orange/5 rounded-xl">
                    <div className="text-3xl font-bold text-saywhat-orange">5</div>
                  ...
                  <div className="text-center p-4 bg-gradient-to-br from-blue-100 to-blue-50 rounded-xl">
                    ...
                    <div className="text-sm font-medium text-gray-600">Trainings Completed</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="bg-gradient-to-r from-black to-gray-800 px-6 py-4">
                <h3 className="text-xl font-bold text-white flex items-center">
                  <StarIcon className="mr-3 h-6 w-6 text-saywhat-orange" />
                  Quick Actions
                </h3>
              </div>
              <div className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <Link
                    ...
                    className="group p-6 bg-gradient-to-br from-saywhat-orange/10 via-saywhat-orange/5 to-transparent rounded-2xl border-2 border-saywhat-orange/20 hover:border-saywhat-orange/40 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <ChartBarIcon className="h-8 w-8 text-saywhat-orange mb-3 group-hover:scale-110 transition-transform duration-200" />
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">Performance</p>
                      <p className="text-sm text-gray-600">View performance plans & appraisals</p>
                    </div>
                  </Link>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">New Plan</p>
                      <p className="text-sm text-gray-600">Create performance plan</p>
                    </div>
                  </Link>
                  
                  <Link
                    href="/employee/performance/appraisals/create"
                    className="group p-6 bg-gradient-to-br from-blue-100 via-blue-50 to-transparent rounded-2xl border-2 border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <StarIcon className="h-8 w-8 text-blue-600 mb-3 group-hover:scale-110 transition-transform duration-200" />
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">Self Appraisal</p>
                      <p className="text-sm text-gray-600">Complete self-assessment</p>
                    </div>
                  </Link>
                  
                  <Link
                    href="/employee/qualifications"
                    className="group p-6 bg-gradient-to-br from-purple-100 via-purple-50 to-transparent rounded-2xl border-2 border-purple-200 hover:border-purple-400 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <AcademicCapIcon className="h-8 w-8 text-purple-600 mb-3 group-hover:scale-110 transition-transform duration-200" />
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">Qualifications</p>
                  ...
                  <Link
                    ...
                    className="group p-6 bg-gradient-to-br from-yellow-100 via-yellow-50 to-transparent rounded-2xl border-2 border-yellow-200 hover:border-yellow-400 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <TrophyIcon className="h-8 w-8 text-yellow-600 mb-3 group-hover:scale-110 transition-transform duration-200" />
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">Training</p>
                      <p className="text-sm text-gray-600">Browse & enroll in programs</p>
                    </div>
                  </Link>
                  
                  <Link
                    href="/employee"
                    className="group p-6 bg-gradient-to-br from-gray-100 via-gray-50 to-transparent rounded-2xl border-2 border-gray-200 hover:border-gray-400 hover:shadow-lg transition-all duration-300 hover:scale-105"
                  >
                    <ArrowTrendingUpIcon className="h-8 w-8 text-gray-600 mb-3 group-hover:scale-110 transition-transform duration-200" />
                    <div>
                      <p className="text-lg font-bold text-gray-900 mb-1">Dashboard</p>
                      <p className="text-sm text-gray-600">Employee portal home</p>
                    </div>
                  </Link>
                </div>
              </div>
