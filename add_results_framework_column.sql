-- Add resultsFramework column to projects table
-- This script adds the missing resultsFramework column to the projects table
...
-- Step 3: Verify the column was added and populated
SELECT 
